...
(() => {
      ...
      `;
        ...
        function goUserArea(user) {
            ...
            if (isLegacyPage()) {
                ...
                // (A) Redirección nueva del área de usuario
        ...
        async function trySaveOrderToApi(order) {
            ...
            for (const url of candidates) {
                try {
                    // (B) Añadir CSRF + headers consistentes
    ...
    // =========================
    (window.__huichplyHeaderLoaded || window.__yevhoHeaderLoaded || Promise.resolve()).then(async () => {
        // (C) Esperar a huichplyAuth.ready antes de requireAuth
